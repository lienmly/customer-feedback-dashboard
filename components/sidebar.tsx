...
import { LayoutDashboard, BarChart3, Settings, FileText, Sparkles } from "lucide-react";
...
export function Sidebar() {
  ...
  return (
    <div className="fixed left-0 top-0 h-screen w-64 border-r border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl p-6">
      {/* Logo/Brand */}
      <div className="mb-10">
